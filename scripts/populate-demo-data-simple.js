...
// Option 1: node --env-file=.env.local scripts/populate-demo-data-simple.js (Node 20.6+)
// Option 2: npm install dotenv && node -r dotenv/config scripts/populate-demo-data-simple.js dotenv_config_path=.env.local
// Option 3: Set environment variables manually before running
...
async function main() {
  ...
  if (existing && existing.length > 0) {
    ...
    console.log('To repopulate, please clear the table first or delete existing entries.')
